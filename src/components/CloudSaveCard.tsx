  ...
  return (
    <div className="rounded-xl border border-tea-200 bg-card p-5">
      ...
      <p className="mt-2 text-base leading-relaxed text-ink">
        ใช้แค่ <strong>อีเมล + รหัสผ่าน</strong> ก็เปิด{copy.thing}
        ได้จากทุกเครื่อง
      </p>
      <p className="mt-2 text-base leading-relaxed text-ink">
        {copy.thing}ถูก<strong>เข้ารหัสในเครื่องของคุณก่อน</strong>
        ส่งขึ้นเซิร์ฟเวอร์ — แม้แต่อีเมลก็ไม่ถูกส่งไป
        เซิร์ฟเวอร์จึงเก็บได้เพียงข้อมูลที่อ่านไม่ออก
        และไม่มีใครถอดได้หากไม่มีรหัสผ่านของคุณ (รวมถึงผู้พัฒนา)
      </p>
      ...
      {savedAs ? (
        <div className="mt-4 rounded-xl border border-tea-200 bg-tea-100/60 p-4">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-6 text-left text-base leading-relaxed text-ink">
            ...
            <li>
              ครั้งถัดไปให้บันทึกด้วยอีเมลและรหัสผ่านชุดเดิม —
              ระบบจะแทนที่ฉบับเก่าให้อัตโนมัติ
            </li>
            <li>
              <strong>หากลืมรหัสผ่าน จะไม่มีใครกู้{copy.thing}นี้ได้</strong>{' '}
              — แต่สร้างใหม่ได้เสมอ
            </li>
            <li>
              {copy.thing}เก็บไว้ 3 ปีนับจากการเปิดครั้งล่าสุด
              แล้วลบตัวเองอัตโนมัติ
            </li>
          </ul>
          {onGoNext ? (
            <button
