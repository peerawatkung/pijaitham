...
export interface SectionDef {
  ...
  footnote?: string
  /**
   * ไม่พิมพ์ส่วนนี้เป็นหัวข้อคำถาม-คำตอบใน PDF —
   * ใช้กับส่วนที่คำตอบไปปรากฏที่อื่นของเอกสารแทน (เช่น พยานในหน้าลงนาม)
   */
  pdfOmit?: boolean
  fields: FieldDef[]
}
...
export const SECTIONS: SectionDef[] = [
  {
    ...
    intro:
      'ข้อมูลพื้นฐานช่วยยืนยันว่าเอกสารฉบับนี้เป็นของคุณจริง — เมื่อถึงเวลาต้องใช้ ครอบครัวและทีมแพทย์จะมั่นใจได้ว่านี่คือเจตนาของคุณ',
    fields: [
      {
        type: 'checkbox',
        id: 'handwritePersonal',
        label: 'ฉันต้องการพิมพ์เอกสารไปเขียนข้อมูลส่วนตัวด้วยปากกาเอง',
        hint: 'ติ๊กข้อนี้ได้ถ้าไม่สะดวกกรอกข้อมูลส่วนตัวลงในเว็บ — ช่องกรอกด้านล่างจะถูกซ่อน และในเอกสารจะมีเส้นเว้นว่างให้เขียนด้วยมือ',
        webOnly: true,
      },
      {
        type: 'text',
      ...
      },
      {
        ...
        hint: 'ช่วยให้เอกสารระบุตัวคุณได้แน่ชัด — หากไม่สะดวกกรอกในเว็บ เว้นไว้แล้วเขียนด้วยปากกาหลังพิมพ์เอกสารได้',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: 'เช่น "กลัวเป็นภาระของลูกหลาน และกลัวการยื้อชีวิตที่ทำให้ทรมานทั้งตัวเองและครอบครัว"\nหรือความกังวลอื่น เช่น ความเจ็บปวด การจากไปโดยไม่ได้บอกลา ค่าใช้จ่ายของครอบครัว',
        rows: 4,
      },
      {
        type: 'textarea',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: 'การอุทิศร่างกายเป็น "อาจารย์ใหญ่" — ลงทะเบียนกับโรงเรียนแพทย์โดยตรงหรือผ่านเว็บไซต์\nเช่น โรงพยาบาลจุฬาลงกรณ์ สภากาชาดไทย, คณะแพทยศาสตร์ศิริราชพยาบาล, คณะแพทยศาสตร์โรงพยาบาลรามาธิบดี',
        options: [
          { value: 'wish', label: 'ประสงค์บริจาค' },
          { value: 'decline', label: 'ไม่ประสงค์' },
          {
  ...
  },
  {
    ...
    intro:
      'พื้นที่นี้เป็นของคุณทั้งหมด — หลายคนบอกว่าหน้านี้มีคุณค่าทางใจที่สุดในเอกสารทั้งฉบับ เขียนในแบบของคุณ ไม่มีถูกหรือผิด',
    fields: [
      {
        type: 'textarea',
        id: 'messageToLoved',
  ...
  {
    id: 'signing-witnesses',
    number: 8,
    title: 'การลงนามและพยาน',
    shortTitle: 'พยาน',
    intro:
      'เอกสารจะสมบูรณ์เมื่อคุณลงนามพร้อมพยาน 2 คนบนฉบับกระดาษ ระบุชื่อพยานที่นี่ได้เลย — ชื่อจะถูกพิมพ์รอไว้ในหน้าลงนาม เหลือเพียงลงลายมือชื่อจริง\nยังไม่รู้ว่าจะให้ใครเป็นพยาน ข้ามได้ (เอกสารจะเว้นเส้นให้เขียนภายหลัง)',
    footnote:
      'พยานทั้งสองคนควรเป็นผู้บรรลุนิติภาวะที่ไม่มีส่วนได้เสียกับคุณ เช่น ไม่ใช่ผู้รับมรดกหรือผู้รับประโยชน์จากกรมธรรม์ประกันชีวิตของคุณ\nอาจเป็นเพื่อน เพื่อนบ้าน เพื่อนร่วมงาน หรือบุคลากรสาธารณสุขก็ได้',
    // ชื่อพยานถูกพิมพ์ในหน้าลงนาม (ส่วนที่ 8 ของ PDF) ไม่ใช่หัวข้อคำถาม-คำตอบ
    pdfOmit: true,
    fields: [
      {
        type: 'text',
        id: 'witness1Name',
        label: 'พยานคนที่ 1: ชื่อ-นามสกุล',
        placeholder: 'เช่น สมหมาย มั่นคง',
      },
      {
        type: 'text',
        id: 'witness1Relation',
        label: 'พยานคนที่ 1: ความสัมพันธ์กับฉัน',
        placeholder: 'เช่น เพื่อนบ้าน',
      },
      {
        type: 'text',
        id: 'witness2Name',
        label: 'พยานคนที่ 2: ชื่อ-นามสกุล',
      },
      {
        type: 'text',
        id: 'witness2Relation',
        label: 'พยานคนที่ 2: ความสัมพันธ์กับฉัน',
      },
    ],
  },
]
...
/**
 * จำนวนขั้นทั้งหมดใน wizard — ส่วนที่ 8 เก็บชื่อพยานล่วงหน้า
 * ส่วนช่องลงลายมือชื่อจริงอยู่ในหน้าลงนามของ PDF เท่านั้น
 */
