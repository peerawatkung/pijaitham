...
export const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    shortTitle: 'พยาน',
    intro:
      'เอกสารจะสมบูรณ์เมื่อคุณลงนามพร้อมพยาน 2 คนบนฉบับกระดาษ — ระบุชื่อพยานไว้ล่วงหน้าได้ที่นี่ เอกสารจะพิมพ์ชื่อรอไว้ในหน้าลงนาม เหลือเพียงลงลายมือชื่อจริง หากยังไม่รู้ว่าจะให้ใครเป็นพยาน ข้ามได้ (ในเอกสารจะเว้นเส้นให้เขียนภายหลัง)',
    footnote:
      'พยานทั้งสองคนควรเป็นผู้บรรลุนิติภาวะที่ไม่มีส่วนได้เสียกับคุณ เช่น ไม่ใช่ผู้รับมรดกหรือผู้รับประโยชน์จากกรมธรรม์ประกันชีวิตของคุณ — อาจเป็นเพื่อน เพื่อนบ้าน เพื่อนร่วมงาน หรือบุคลากรสาธารณสุขก็ได้',
