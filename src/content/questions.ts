  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: 'เช่น กลัวเป็นภาระของลูกหลาน กลัวความเจ็บปวด กลัวถูกยื้อชีวิตด้วยเครื่องมือแพทย์ กลัวจากไปโดยไม่ได้บอกลา หรือกังวลเรื่องค่าใช้จ่ายของครอบครัว',
        rows: 4,
      },
      {
        type: 'textarea',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: 'เช่น เพลงที่ชอบ บทสวด ความเงียบ หรือคนที่อยากให้อยู่ใกล้ ๆ',
        rows: 3,
      },
      {
        type: 'textarea',
        ...
        hint: 'เช่น ฟังธรรม สวดมนต์ หรือพิธีทางศาสนาอื่น',
        rows: 3,
      },
    ],
  },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: 'เช่น ศาสนา ประเพณี จำนวนวัน ความเรียบง่ายหรือจัดเต็ม',
        rows: 3,
      },
      {
        type: 'textarea',
        ...
        hint: 'เช่น รูปที่อยากใช้ เพลง ดอกไม้ สีที่ชอบ',
        rows: 3,
      },
      {
        type: 'textarea',
        ...
        hint: 'เช่น พินัยกรรม กรมธรรม์ สมุดบัญชี — ระบุเพียง "ที่เก็บ" ไม่ต้องใส่รายละเอียดเอกสารในนี้',
        rows: 3,
      },
    ],
  },
