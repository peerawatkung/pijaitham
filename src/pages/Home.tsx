...
const HOW_STEPS = [
  ...
  'ปริ้น ลงนามพร้อมพยาน 2 คนให้ครบถ้วน แล้วพูดคุยแจ้งให้ครอบครัวหรือคนใกล้ชิดทราบว่าได้จัดทำเอกสารนี้ไว้',
  'มอบสำเนาให้ผู้ตัดสินใจแทนและโรงพยาบาลที่รักษาประจำ ส่วนต้นฉบับเก็บในที่ที่หาง่าย และดาวน์โหลดการ์ดพกกระเป๋าเก็บไว้ในกระเป๋าสตางค์ — บนการ์ดระบุที่เก็บเอกสารและคนที่ให้ติดต่อ',
] as const
