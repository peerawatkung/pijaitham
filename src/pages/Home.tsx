...
// ขั้นที่ 3–4 ให้สอดคล้องกับ "ขั้นตอนถัดไป" ในหน้า Done (content/checklist.ts NEXT_STEPS)
const HOW_STEPS = [
  'ตอบคำถามทีละข้อ ตามจังหวะของคุณ — ข้อไหนยังไม่พร้อม ข้ามได้',
  'ตรวจทาน แล้วเลือกวิธีเก็บ — เก็บออนไลน์ด้วยอีเมล+รหัสผ่าน เปิดได้จากทุกเครื่อง หรือดาวน์โหลด PDF ไปพิมพ์',
  'บอกครอบครัวและผู้ตัดสินใจแทนว่าทำเอกสารนี้ไว้ — ฉบับกระดาษให้ลงชื่อพร้อมพยาน 2 คน',
  'มอบสำเนาให้ผู้ตัดสินใจแทนและแพทย์ประจำตัว — และกลับมาทบทวนทุก 1 ปี',
] as const
      ...
      <section className="mt-10 rounded-xl border border-dawn-100 bg-dawn-100/40 p-5">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-relaxed text-ink">
          ...
          <li>
            ...
            และลบตัวเองอัตโนมัติเมื่อไม่ได้เปิดเกิน 3 ปี
          </li>
        </ul>
      </section>
