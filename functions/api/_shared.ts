 ...
 * - เอกสารหมดอายุเอง 1 ปีนับจากการใช้งานล่าสุด (KV TTL ต่ออายุทุกครั้งที่เปิด)
 *
 * ไฟล์ขึ้นต้นด้วย _ จะไม่ถูก map เป็น route โดย Pages Functions
 */

/** อายุเอกสารบนเซิร์ฟเวอร์ — 1 ปีนับจากการเขียน/เปิดครั้งล่าสุด */
export const DOC_TTL_SECONDS = 60 * 60 * 24 * 365
